...
function openZhaocaiAiRightForm() {
  ...
  S.zcAiFormOpen = true;
  S.zcAiDraft = { quota: '', startAt: v3DateTimeInput(start), endAt: v3DateTimeInput(end), remark: '' };
  render();
}
