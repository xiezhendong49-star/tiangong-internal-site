...
function v5ChooseImageProject(id){const f=S.v3AdminForm,p=v5Project(id);f.projectId=p&&p.business===f.primary?.slice(2)&&p.status==='启用'?id:'';render();}
function v5ChooseImageProductLine(id){S.v3AdminForm.primary=id;S.v3AdminForm.projectId='';render();}
